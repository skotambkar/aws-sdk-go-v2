...
// DefaultCacheSize is the default endpoint discovery cache size that should be
// used to construct endpoint cache, if not provided by customer
const DefaultEndpointCacheSize int64 = 10
